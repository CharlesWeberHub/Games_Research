...
six_months_static_file_path='/Users/charles/PycharmProjects/Games_Research/IV_append/genre_statistic/genre_statis(6 months).csv'
...
genre_IV_df.to_csv('/Users/charles/PycharmProjects/Games_Research/IV_append/genre_append_iv/IV_count_6_months.csv')
