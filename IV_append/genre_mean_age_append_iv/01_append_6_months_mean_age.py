...
genre_file_path = '/Users/charles/PycharmProjects/Games_Research/IV_append/genre_csv_output/'
...
id_genre_statis_df.to_csv('/Users/charles/PycharmProjects/Games_Research/IV_append/genre_mean_age_append_iv/' + 'genre_statis_mean_age(6 months).csv')
id_age_statis_df.to_csv('/Users/charles/PycharmProjects/Games_Research/IV_append/genre_mean_age_append_iv/' + 'age_statis_mean_age(6 months).csv')
average_age_df.to_csv('/Users/charles/PycharmProjects/Games_Research/IV_append/genre_mean_age_append_iv/' + 'average_age(6 months).csv')
