...
game_features_file_path = '/Users/charles/PycharmProjects/Games_Research/add_ranking_company_age_colume/games-features(major_company).csv'
...
game_features_df.to_csv(
    '/Users/charles/PycharmProjects/Games_Research/add_ranking_company_age_colume/games-features(days).csv')
...
game_features_df.to_csv(
    '/Users/charles/PycharmProjects/Games_Research/add_ranking_company_age_colume/games-features(age).csv')
...
# game_features_df.to_csv(
#     '/Users/charles/PycharmProjects/Games_Research/add_ranking_company_age_colume/games-features(age_month6).csv')

# game_features_df.to_csv(
#     '/Users/charles/PycharmProjects/Games_Research/add_ranking_company_age_colume/games-features(age_month12).csv')

game_features_df.to_csv(
    '/Users/charles/PycharmProjects/Games_Research/add_ranking_company_age_colume/games-features(age_quarter6).csv')
