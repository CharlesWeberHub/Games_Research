...
games_features_path = '/Users/charles/PycharmProjects/Games_Research/add_ranking_company_age_colume/games-features(age_quarter6).csv'
...
remain_games_features_df.to_csv('/Users/charles/PycharmProjects/Games_Research/append_monthly_quarterly/new_form(6_quarters).csv')
