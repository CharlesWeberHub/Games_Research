...
remain_id_file_path = '/Users/charles/PycharmProjects/Games_Research/append_monthly_quarterly/final(6).csv'
...
monthly_data_features_df.to_csv('/Users/charles/PycharmProjects/Games_Research/check_price_change/merge_month.csv')