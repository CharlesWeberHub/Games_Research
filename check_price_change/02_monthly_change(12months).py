...
remain_id_file_path = '/Users/charles/PycharmProjects/Games_Research/append_monthly_quarterly/final(12).csv'

remain_id_df=pd.read_csv(remain_id_file_path)

monthly_data_df=pd.read_csv('/Users/charles/PycharmProjects/Games_Research/Filter_Excel_From_HTML/OUTPUT_DATA/Calendar_monthly_csv/2016-01-01 to 2016-01-31 (monthly_data).csv',index_col=0)
...
monthly_data_features_df.to_csv('/Users/charles/PycharmProjects/Games_Research/check_price_change/merge_12_month.csv')