...
game_features_file_path = '/Users/charles/PycharmProjects/Games_Research/data/game_features(all_static_variables)/games-features.csv'
remain_games_id_name_file_path='/Users/charles/PycharmProjects/Games_Research/data/remain_games/remain_games_id_name_2018-12-18 to 2019-03-11(after_delete_not_in_yearly).csv'
