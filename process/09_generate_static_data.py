...
all_steam_year = pd.read_csv('/Users/charles/PycharmProjects/Games_Research/data/yearly_data_for_static_variable/merge_yearly_data.csv')
res_id_name = pd.read_csv('/Users/charles/PycharmProjects/Games_Research/data/game_features(all_static_variables)/games-features.csv')
