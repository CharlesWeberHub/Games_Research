...
whole_single_df = pd.read_csv('/Users/charles/PycharmProjects/Games_Research/data/biweekly(singlesheet_instatic_plus_time_period)/singlesheet_instatic.csv')[['ID', 'Name', 'Time_period', 'Owners before', 'Owners after', 'Sales', 'Price', 'Max discount','Userscore (Metascore)']]
...
whole_single_df.to_csv('/Users/charles/PycharmProjects/Games_Research/data/biweekly(split_score)/' + 'singlesheet_instatic_plus_time_period_split_score.csv')


static_data_df = pd.read_csv('/Users/charles/PycharmProjects/Games_Research/data/biweekly(static_data)/static.csv')
print(static_data_df.info())

major_company_file_path = '/Users/charles/PycharmProjects/Games_Research/data/major_company/'
...
static_data_df[['ID', 'Name', 'Release date','RequiredAge', 'Developer(s)', 'Publisher(s)', 'PlatformWindows', 'PlatformLinux',
                'PlatformMac', 'isMajorCompany']].to_csv('/Users/charles/PycharmProjects/Games_Research/data/biweekly(static_data)/static_plus_major_company.csv')
