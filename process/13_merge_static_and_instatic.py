...
whole_single_df = pd.read_csv('/Users/charles/PycharmProjects/Games_Research/data/biweekly(split_score)/singlesheet_instatic_plus_time_period_split_score.csv')
whole_static_df = pd.read_csv('/Users/charles/PycharmProjects/Games_Research/data/biweekly(static_data)/final_repeat_static.csv')
