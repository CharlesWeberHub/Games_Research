...
file_path = '/Users/charles/PycharmProjects/Games_Research/data/monthly_data/remain_games/remain_games_name_2019-02-25 to 2019-12-29.csv'
...
def name_match_id():
    ...
    df_idlist = pd.read_csv(
        '/Users/charles/PycharmProjects/Games_Research/data/monthly_data/steam_spy_id_name_list_from_html_table/all_id_name 2018-01-01 to 2020-01-26.html.csv')
    ...
    id_name_df[['ID','Name']].to_csv('/Users/charles/PycharmProjects/Games_Research/data/monthly_data/remain_games/remain_games_id_name_2019-02-25 to 2019-12-29.csv')
