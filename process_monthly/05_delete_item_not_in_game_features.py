...
game_features_file_path = '/Users/charles/PycharmProjects/Games_Research/data/monthly_data/game_features(all_static_variables)/games-features.csv'
remain_games_id_name_file_path= '/Users/charles/PycharmProjects/Games_Research/data/monthly_data/remain_games/remain_games_id_name_2019-02-25 to 2019-12-29(after_delete_not_in_yearly).csv'
...
id_name.to_csv('/Users/charles/PycharmProjects/Games_Research/data/monthly_data/remain_games/remain_games_id_name_2019-02-25 to 2019-12-29(after_delete_not_in_game_features).csv')
