...
file_path = '/Users/charles/PycharmProjects/Games_Research/data/monthly_data/monthly'
...
def create_frame_file():
    for i in range(0, len(file_list)):
        ...
        weekly_data_df.to_csv(
            '/Users/charles/PycharmProjects/Games_Research/data/monthly_data/monthly(after filter)/' + str(time_period_list[i]) + '.csv')
        print('hello')
