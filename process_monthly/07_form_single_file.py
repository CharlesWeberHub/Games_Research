...
file_path = '/Users/charles/PycharmProjects/Games_Research/data/monthly_data/monthly(after filter)/'
...
while cut_game_index < game_size:
    ...
    if cut_game_index == 300:
        ...
        whole_single_df.to_csv('/Users/charles/PycharmProjects/Games_Research/data/monthly_data/monthly(after_overlap)/' + str(file_id) + 'static.csv')
        print(str(file_id))
        end = time.time()
        print("Run_Cost:%.2f Second" % (end - start))
        file_id += 1
