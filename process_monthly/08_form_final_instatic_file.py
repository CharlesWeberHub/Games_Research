...
file_path = '/Users/charles/PycharmProjects/Games_Research/data/monthly_data/monthly(after_overlap)/'
...
whole_single_df[['ID', 'Name', 'Time_period', 'Owners before', 'Owners after', 'Sales', 'Price', 'Max discount',
    ...
    '/Users/charles/PycharmProjects/Games_Research/data/monthly_data/monthly(singlesheet_instatic_plus_time_period)/' + 'singlesheet_instatic.csv')
