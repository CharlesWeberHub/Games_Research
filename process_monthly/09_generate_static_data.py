...
all_steam_year = pd.read_csv('/Users/charles/PycharmProjects/Games_Research/data/monthly_data/yearly_data_for_static_variable/merge_yearly_data.csv')
res_id_name = pd.read_csv('/Users/charles/PycharmProjects/Games_Research/data/monthly_data/game_features(all_static_variables)/games-features.csv')
id_name = pd.read_csv(
    '/Users/charles/PycharmProjects/Games_Research/data/monthly_data/remain_games/remain_games_id_name_2019-02-25 to 2019-12-29(after_delete_not_in_game_features).csv')[['ID', 'Name']]
...
sta_data_df.to_csv('/Users/charles/PycharmProjects/Games_Research/data/monthly_data/monthly(static_data)/static.csv')
print('hello')
