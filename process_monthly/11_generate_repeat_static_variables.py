...
static_data_df = pd.read_csv('/Users/charles/PycharmProjects/Games_Research/data/monthly_data/monthly(static_data)/static_plus_major_company.csv')[
...
output_file_path= '/Users/charles/PycharmProjects/Games_Research/data/monthly_data/monthly(static_data_repeat)/'
...
while cut_game_index < game_size:
    ...
    if cut_game_index == 300:
        ...
        for index in range(cut_game_index, cut_game_index + 99):
            for i in range(0, periods):
                repeat_static_df = repeat_static_df.append(static_data_df.loc[index, :])
