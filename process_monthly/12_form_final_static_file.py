...
file_path = '/Users/charles/PycharmProjects/Games_Research/data/monthly_data/monthly(static_data_repeat)/'
...
whole_single_df.to_csv('/Users/charles/PycharmProjects/Games_Research/data/monthly_data/monthly(static_data)/'+'final_repeat_static.csv')