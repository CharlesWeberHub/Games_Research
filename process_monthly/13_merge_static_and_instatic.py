...
whole_single_df = pd.read_csv(
    '/Users/charles/PycharmProjects/Games_Research/data/monthly_data/monthly(split_score)/singlesheet_instatic_plus_time_period_split_score.csv')
whole_static_df = pd.read_csv('/Users/charles/PycharmProjects/Games_Research/data/monthly_data/monthly(static_data)/final_repeat_static.csv')
...
df1.to_csv('/Users/charles/PycharmProjects/Games_Research/data/monthly_data/merged_data/'+'singlesheet.csv')
