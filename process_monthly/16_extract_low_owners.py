...
singlesheet_df = \
    pd.read_csv('/Users/charles/PycharmProjects/Games_Research/data/monthly_data/merged_data/singlesheet_discounted.csv')[
...
group_df.to_csv('/Users/charles/PycharmProjects/Games_Research/data/monthly_data/group_results/' + 'result.csv')
group_df = pd.read_csv('/Users/charles/PycharmProjects/Games_Research/data/monthly_data/group_results/' + 'result.csv').drop(
...
singlesheet_df[['ID', 'Name', 'Time_period', 'Owners before', 'Owners after', 'Sales', 'Price', 'Max discount',
    ...
    '/Users/charles/PycharmProjects/Games_Research/data/monthly_data/merged_data/singlesheet_low_owner.csv')
