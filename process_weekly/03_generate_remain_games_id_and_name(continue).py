...
file_path = '/data/bi_weekly_data/remain_games/remain_games_name_2018-12-18 to 2019-03-11.csv'
...
def name_match_id():
    ...
    df_idlist = pd.read_csv(
        '/data/bi_weekly_data/steam_spy_id_name_list_from_html_table/all_id_name 2018-12-18 to 2019-03-11.csv')
