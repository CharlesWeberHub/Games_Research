...
whole_single_df = pd.read_csv(
    '/data/bi_weekly_data/biweekly(singlesheet_instatic_plus_time_period)/singlesheet_instatic.csv')[['ID', 'Name', 'Time_period', 'Owners before', 'Owners after', 'Sales', 'Price', 'Max discount', 'Userscore (Metascore)']]
...
static_data_df = pd.read_csv('/data/bi_weekly_data/biweekly(static_data)/static.csv')
print(static_data_df.info())

major_company_file_path = '/data/bi_weekly_data/major_company/'
