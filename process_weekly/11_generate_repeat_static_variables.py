...
static_data_df = pd.read_csv('/data/bi_weekly_data/biweekly(static_data)/static_plus_major_company.csv')[
...
output_file_path= '/data/bi_weekly_data/biweekly(static_data_repeat)/'
